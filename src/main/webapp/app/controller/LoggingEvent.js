Ext.define('Desktop.controller.LoggingEvent', {
	...
	deleteAll: function() {
		...
		loggingEventService.deleteAll(filter && filter.value, function() {
			Desktop.ux.window.Notification.info(i18n.successful, i18n.logevents_deleted);
			this.doGridRefresh();
		}, this);
	},
	...
	addTestData: function() {
		loggingEventService.addTestData(function() {
			Desktop.ux.window.Notification.info(i18n.successful, i18n.logevents_testinserted);
			this.doGridRefresh();
		}, this);
