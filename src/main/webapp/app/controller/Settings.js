Ext.define('Desktop.controller.Settings', {
	...
	onOkButtonClick: function() {
		...
		if (this.getUserSettingsPanel().isValid()) {
			this.getUserSettingsPanel().submit({
				scope: this,
				success: function() {
					Desktop.ux.window.Notification.info(i18n.successful, i18n.settings_saved);
					this.getView().close();
				}
			});
		}
	...
	onResetWindowPosButtonClick: function() {
		Ext.state.Manager.clear('Desktop.view.AccessLogWindow');
		Ext.state.Manager.clear('Desktop.view.LoggingEventsWindow');
		Ext.state.Manager.clear('Desktop.view.Settings');
                Ext.state.Manager.clear('Desktop.view.Feedback');
		Ext.state.Manager.clear('Desktop.view.UsersWindow');
		Ext.state.Manager.clear('Desktop.view.SystemSettings');
                Ext.state.Manager.clear('Desktop.view.ConfigurationWindow');
		Desktop.ux.window.Notification.info(i18n.successful, i18n.settings_windowpositionsreseted);
	}
