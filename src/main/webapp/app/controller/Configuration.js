Ext.define('Desktop.controller.Configuration', {
	...
	onSaveButtonClick: function() {
		...
		this.getConfigurationEditPanel().submit({
			success: function(form, action) {
				Desktop.ux.window.Notification.info(i18n.successful, i18n.configuration_saved);
				me.getView().close();
			}
		});
	},
			...
			this.getConfigurationEditPanel().submit({
				success: function(form, action) {
					...
					appConfigurationService.sendTestEmail(testReceiver, function() {
						Desktop.ux.window.Notification.info(i18n.successful, i18n.configuration_testEmailsent);
					});
				}
			});
		} else {
