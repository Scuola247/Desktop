Ext.define('Desktop.controller.User', {
	extend: 'Deft.mvc.ViewController',
	requires : [ 'Desktop.store.Users' ],
	store: Ext.create('Desktop.store.Users'),
	...
	afterConfirmDelete: function(btn) {
		if (btn === 'yes') {
			...
			if (record) {
				...
				Desktop.ux.window.Notification.info(i18n.successful, i18n.user_deleted);
			}
		}
	},
	...
	onSaveButtonClick: function() {
		...
		form.submit({
			...
			success: function() {
				this.getGrid().getStore().load();
				Desktop.ux.window.Notification.info(i18n.successful, i18n.user_saved);
			}
		});
