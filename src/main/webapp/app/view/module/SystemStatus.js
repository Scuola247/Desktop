Ext.define('Desktop.view.module.SystemStatus', {
	...
	initComponent: function() {
		...
		this.items = [ {
			...
			items: [ me.createCpu1LoadChart(), me.createCpu2LoadChart() ]
		}, {
			flex: 1,
			xtype: 'container',
			layout: {
			...
			items: [ me.createMemoryPieChart(), me.createProcessChart() ]
		} ];
		...
		return {
			...
			series: [ {
				...
				renderer: function(sprite, record, attr, index, store) {
					var lowColor = Ext.draw.Color.fromString('#b1da5a'), value = record.get('memory'), color;
