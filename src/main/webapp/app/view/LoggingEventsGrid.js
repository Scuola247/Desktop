Ext.define('Desktop.view.LoggingEventsGrid', {
	extend: 'Ext.grid.Panel',

	requires: [ 'Desktop.ux.form.field.ClearCombo', 'Desktop.store.LogLevels', 'Desktop.store.LoggingEvents' ],
	...
	initComponent: function() {
		...
		me.store = Ext.create('Desktop.store.LoggingEvents');
		...
		me.dockedItems = [ {
			...
			items: [ {
				...
				name: 'logLevelFilter',
				store: Ext.create('Desktop.store.LogLevels'),
				valueField: 'level',
				displayField: 'level',
				queryMode: 'local',
				forceSelection: true
